(function(mod) {
	...
	mod.controller('documentCtrl', function($scope,$http,$interval,ngTableParams, ngProgress) {
		ngProgress.start();
		...
		$http.get('/document').success(function(data){   
			$scope.logs=data;
			initTableData();
			ngProgress.complete();
		});
...
})(angular.module('document', ['ngRoute']));